...
const reportEvent = module.exports._reportEvent = function (evtHolder) {
    ...
    switch (evtHolder.type) {
        case  EVENT.TYPE.REQUEST_RECORD:
            return BackEnd.request_record(Agent.SESSION_ID(), evtHolder.event);
        case EVENT.TYPE.ATTACK:
            return BackEnd.attack(Agent.SESSION_ID(), evtHolder.event);
        case EVENT.TYPE.ERROR:
            return BackEnd.exception(Agent.SESSION_ID(), evtHolder.event);
        case EVENT.TYPE.AGENT_MESSAGE:
            return BackEnd.agent_message(Agent.SESSION_ID(), evtHolder.event);
        default:
            return Promise.resolve();
    }
};
