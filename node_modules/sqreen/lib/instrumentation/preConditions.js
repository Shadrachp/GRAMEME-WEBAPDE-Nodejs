...
const evalPreCond = function (condition, binder, args, value, selfObject, session) {
    ...
    if (typeof condition === 'object') {
        ...
        if (keys.length === 0 || !operators[keys]) {
            return false;
        }
        return operators[keys[0]].apply(null, condition[keys].map((item) => evalPreCond(item, binder, args, value, selfObject, session)));
    }
    return condition;
};
...
module.exports._evalPreCond = evalPreCond;
