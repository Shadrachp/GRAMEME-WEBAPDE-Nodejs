...
module.exports.placePatch = function (updatePayload) {
    ...
    // FIXME: with the current system, it is not possible to go into deep nested methods
    if (updatePayload.moduleName === 'global' && typeof global[updatePayload.methodName] === 'function') {
        FunctionPatcher.patchFunction(global, updatePayload.methodName, {
            name: 'global',
            core: true,
            internal: false
        }, '');
