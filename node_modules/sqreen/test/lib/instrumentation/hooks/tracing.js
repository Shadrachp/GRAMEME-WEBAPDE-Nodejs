...
describe('Instrumentation', () => {
    ...
    describe('Tracing', () => {
        ...
        it('should trace calls but block due to action', { plan: 1 }, (done) => {

            const Actions = require('../../../../lib/actions');
            Actions.enforceActionList([{ action_id: 1, action: 'block_ip', parameters: { ip_cidr: '192.168.0.1/24' } }]);
            const Server = function Server() {
            ...
            const _req = new EventEmitter();
            _req.name = 'req';
            _req.headers = { 'x-forwarded-for': '192.168.0.252' };
            const _res = new EventEmitter();
            _res.name = 'res';
            _res.writeHead = function (code) {

                expect(code).to.equal(500);
            };
            _res.end = function () {};
            _req.socket = { end: done };
