...
describe('moduleHijacker', () => {
    ...
    describe('enable', () => {
        ...
        it('should remove Sqreen from stacktraces when requireing non existing modules', { plan: 1 }, (done) => {
            ...
            try {
                ...
                expect(err.stack).to.not.include('moduleHijacker');
                done();
            }
        });
        ...
        it('should catch the loading of http and fail to hook it', { plan: 2 }, (done) => {
        ...
        it('should catch the loading of templating engine and fail to hook it', { plan: 2 }, (done) => {
