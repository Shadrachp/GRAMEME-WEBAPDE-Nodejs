...
describe('Patch', () => {
    ...
    describe('_report', () => {
        ...
        it('should report an attack to Record', { plan: 2 }, (done) => {

            const req = {
                __sqreen_uuid: 10
            };
            const record = new Record.Record(req);

            record.attack = function (args) {

                expect(args.rule_name).to.equal('rule');
        ...
        it('should report an attack to Record without rule', { plan: 2 }, (done) => {
            ...
            record.attack = function (args) {
                ...
                expect(args.rule_name).to.equal(undefined);
                expect(args.headers).to.not.exist();
    ...
    describe('_actOnCbResult', () => {
        ...
        it('should not skip even if the rule is in test because of SQREEN_BLOCK_ALL but fail with metric reporting', { plan: 2 }, (done) => {
