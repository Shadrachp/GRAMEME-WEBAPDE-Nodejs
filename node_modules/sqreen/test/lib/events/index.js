...
describe('Event.queue', () => {
    ...
    describe('writeEvent', () => {
        ...
        it('should report a simple event', { plan: 3 }, (done) => {
            ...
            MockedEvent.writeEvent('ATTACK', { rule_name: 'a' });
        });
        ...
        it('should report a simple event', { plan: 2 }, (done) => {
            ...
            MockedEvent.writeEvent('ATTACK', { klass: 'a' });
        });
        ...
        it('should report a request_record', { plan: 12 }, (done) => {
            ...
            MockedEvent.writeEvent('request_record', record);
            MockedEvent.writeEvent('request_record', record2);
            MockedEvent.writeEvent('request_record', record3);
            MockedEvent.writeEvent('request_record', record4);
        });
