    ...
    describe('reportEvent', () => {
        ...
        it('should report an attack', { plan: 2 }, () => {
            ...
            const MockedAction = Proxyquire('../../../lib/events/action', {
                ...
                '../backend': {
                    request_record: function (token, atk) {
            ...
            return MockedAction._reportEvent({ type: 'request_record', event: {} });
        });
        ...
        it('should report an message', { plan: 2 }, () => {
            ...
            const MockedAction = Proxyquire('../../../lib/events/action', {
                ...
                '../backend': {
                    agent_message: function (token, msg) {
            ...
            return MockedAction._reportEvent({ type: 'agent_message', event: {} });
        });
    });
