...
describe('Config', () => {
    ...
    describe('readConfig', () => {
        ...
        it('should read the conf from env variables', { plan: 12 }, (done) => {
            ...
            process.env.SQREEN_HTTP_PROXY = 'https://proxy.sqreen.io';
            process.env.SQREEN_IP_HEADER = 'my-header';
            ...
            expect(read.http_proxy).to.equal('https://proxy.sqreen.io');
            expect(read.ip_header).to.equal('my-header');
            ...
            delete process.env.SQREEN_IP_HEADER;
